            ...
            <div className="max-w-md w-full space-y-8 animate-in fade-in zoom-in duration-700">
                ...
                <div className="space-y-4">
                    <div className="relative inline-block">
                        <span className="text-9xl font-black font-outfit text-green/5 select-none">404</span>
                    ...
                    <p className="text-muted font-jakarta text-lg">
                        Parece que la página que buscas ha cambiado de lugar o ya no existe. No te preocupes, regresa a la página principal para seguir explorando.
                    </p>
                </div>
                ...
                <div className="pt-8 flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <Link href="/buscar">
                        <Button variant="outline" className="border-border hover:bg-white text-muted rounded-2xl px-8 h-14 font-black uppercase text-[11px] tracking-widest w-full sm:w-auto">
                ...
                <div className="pt-20 opacity-20 pointer-events-none">
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-muted">Enlace San Juan ®</p>
                </div>
            </div>
