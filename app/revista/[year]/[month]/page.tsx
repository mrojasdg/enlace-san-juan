...
export default async function PublicMagazinePage({ params }: { params: { year: string, month: string } }) {
    const { year, month } = params;
    ...
    const finalPagesToRender = validPages.filter(p => p.page_number <= totalPages);
