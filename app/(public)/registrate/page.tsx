            ...
            <main className="container max-w-7xl mx-auto px-6 py-12">
                <div className="max-w-3xl mx-auto text-center mb-12 space-y-4">
                    ...
                    <p className="text-muted font-jakarta text-lg">
                        Llena el siguiente formulario con la información de tu empresa. <br className="hidden sm:block"/>
                        Nosotros nos encargaremos de armar tu micrositio para que miles de sanjuanenses te encuentren fácilmente.
                    </p>
                </div>
  ...
  return (
    <div className="min-h-screen pt-20 bg-[#F9FCFA]">
      ...
      <main className="container max-w-7xl mx-auto px-4 md:px-6 py-12">
        <div className="max-w-3xl mx-auto text-center mb-12 space-y-4 px-2">
          <span className="bg-green-xpale text-green px-4 py-2 rounded-full font-black text-[10px] uppercase tracking-widest inline-flex items-center gap-2 border border-green/20">
            <span className="w-2 h-2 rounded-full bg-green animate-pulse"></span>
            ÚNETE AL DIRECTORIO
          </span>
          <h1 className="font-outfit font-black text-3xl md:text-5xl text-green-deeper leading-tight">
            Registra tu negocio
          </h1>
          <p className="text-muted font-jakarta text-base md:text-lg">
