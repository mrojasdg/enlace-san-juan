        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-16">
            ...
            <section className="relative rounded-[1.5rem] overflow-hidden bg-white shadow-2xl border border-border group">
              ...
              <div className="px-6 md:px-8 pb-3 md:pb-5 -mt-20 md:-mt-28 relative z-10 flex flex-col md:flex-row items-end gap-5 md:gap-8 text-center md:text-left">
                ...
                <div className="flex-1 pb-1 md:pb-2">
                  ...
                  <div className="flex flex-col items-center md:items-start gap-2 md:gap-3 mt-6 md:mt-10">
