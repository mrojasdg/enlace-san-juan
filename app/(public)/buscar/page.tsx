...
export default function SearchPage({ searchParams }: { searchParams: any }) {
    ...
    useEffect(() => {
        const fetchResults = async () => {
            ...
            const { data, count: total } = await query.order("is_featured", { ascending: false });
            setBusinesses(data || []);
            setCount(total || 0);
            setIsLoading(false);
        };
            ...
            <div className="flex-1 flex overflow-hidden relative">
                ...
                <section className="flex-1 h-full overflow-hidden flex flex-col lg:flex-row relative">
                    ...
                    <div className={cn(
                        ...
                        <SearchResults businesses={businesses} total={count} isLoading={isLoading} />
                    </div>
                ...
                <div className="lg:hidden fixed inset-0 z-[100] bg-white animate-in slide-in-from-bottom duration-300">
                    <div className="h-full flex flex-col">
                        <div className="p-6 border-b border-border flex items-center justify-between">
                            <h2 className="font-outfit font-black text-xl text-ink">Filtros</h2>
                            <button
