            ...
            <div className="w-full max-w-lg relative z-10 flex flex-col items-center">
                ...
                <div className="mb-12 text-center flex flex-col items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 bg-white/5 px-4 py-1.5 rounded-full border border-white/10 backdrop-blur-md">
                        ...
                        <span className="text-[10px] font-black text-white/40 uppercase tracking-[0.2em]">Acceso Administrativo</span>
                    </div>
                </div>
                ...
                <div className="w-full bg-white rounded-[3rem] p-10 md:p-14 shadow-2xl border border-white/5 relative overflow-hidden group">
                    ...
                    <div className="mb-10">
                        <h1 className="font-outfit font-black text-4xl text-green-deeper leading-tight mb-3">Panel de <br /> Gestión</h1>
                        <p className="text-muted font-jakarta text-sm leading-relaxed max-w-[240px]">Inicia sesión para administrar los negocios en el directorio local.</p>
                    </div>

                    <form onSubmit={handleLogin} className="space-y-8">
                        <div className="space-y-5">
                            <div className="space-y-2 group">
                                <label className="text-[10px] font-black text-muted uppercase tracking-[0.15em] ml-2 block group-focus-within:text-green-mid transition-colors">Correo Electrónico</label>
                                <div className="relative">
                                    <Mail className="absolute left-5 top-1/2 -translate-y-1/2 text-muted group-focus-within:text-green-mid transition-all" size={20} />
                                    <input
                                        type="email"
                                        required
                            ...
                            <div className="space-y-2 group">
                                <label className="text-[10px] font-black text-muted uppercase tracking-[0.15em] ml-2 block group-focus-within:text-green-mid transition-colors">Contraseña Segura</label>
                                <div className="relative">
                                    <Lock className="absolute left-5 top-1/2 -translate-y-1/2 text-muted group-focus-within:text-green-mid transition-all" size={20} />
                                    <input
                                        type="password"
                                        required
                                        placeholder="••••••••••••"
                    ...
                    <div className="mt-12 pt-8 border-t border-border flex items-center justify-between text-[10px] font-black text-muted uppercase tracking-widest gap-2">
                        ...
                        <Link href="/" className="hover:text-green-mid transition-colors">Volver al sitio público</Link>
                    </div>
                </div>
