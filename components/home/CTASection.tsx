...
export const CTASection = () => {
    ...
    return (
        <section id="registrar" className="py-24 px-6 md:px-12 bg-green-dark relative overflow-hidden">
            ...
            <div className="container mx-auto text-center relative z-10 flex flex-col items-center max-w-4xl">
                    ...
                    {plans.map((plan) => (
                        ...
                        >
                            ...
                            <div className="text-left">
                                <h4 className="font-outfit font-black text-xl text-white leading-none mb-1">{plan.name}</h4>
                                <p className="text-xs font-bold text-white/50 uppercase tracking-widest">{plan.label}</p>
                            </div>
                        </div>
                    ))}
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-6 w-full max-w-2xl justify-center mx-auto items-center">
                    <Link href="/registrate" className="w-full sm:w-auto group">
                        <Button size="lg" className="w-full sm:w-auto px-10 bg-white text-green-deeper hover:bg-white/90 scale-100 hover:scale-105 active:scale-95 shadow-[0_20px_40px_rgba(0,0,0,0.2)] rounded-2xl py-6 text-lg font-black tracking-tight flex items-center justify-center gap-3 whitespace-nowrap">
                            Registra tu negocio
                        </Button>
                    </Link>
                    <Link href="mailto:hola@enlacesanjuan.com.mx" className="w-fit flex items-center gap-3 text-white/60 hover:text-white text-sm font-bold uppercase tracking-widest transition-colors py-4">
                        <Mail size={20} />
