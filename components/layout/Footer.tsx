        ...
        <footer className="bg-green-deeper text-white py-16 px-6 md:px-12">
            <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-white/50 text-sm leading-relaxed max-w-[240px]">
                        El directorio digital más completo de San Juan del Río. Conectamos negocios locales con su comunidad.
                    </p>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <ul className="space-y-3">
                        {["Gastronomía", "Salud", "Belleza", "Retail"].map(
                            (item) => (
                                <li key={item}>
                                    <Link
                ...
                <div className="space-y-6">
                    ...
                    <ul className="space-y-3">
                        <li>
                            <Link href="/precios" className="text-white/50 hover:text-white/85 text-sm transition-colors">
                                Ver Paquetes
                            </Link>
                        </li>
                        <li>
                            <Link href="/revista" className="text-white/50 hover:text-white/85 text-sm transition-colors">
                                Revista Digital
                            </Link>
                        </li>
                        <li>
                            <Link href="/registrate" className="text-white/50 hover:text-white/85 text-sm transition-colors">
                                Registra tu negocio
                            </Link>
                        </li>
                    </ul>
                ...
                <div className="space-y-6">
                    ...
                    <ul className="space-y-3">
                        <li className="text-white/50 text-sm">San Juan del Río, Qro. México</li>
                        <li>
                            <Link
                        ...
                        <li className="flex items-center gap-2">
                            <svg viewBox="0 0 24 24" width="16" height="16" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="text-white/50">
            ...
            <div className="container mx-auto mt-16 pt-8 border-t border-white/10 text-center sm:text-left">
                <p className="text-white/30 text-xs font-jakarta">
                    © {new Date().getFullYear()} Enlace San Juan. Todos los derechos reservados.
                </p>
            </div>
        </footer>
    );
...
import Link from 'next/link';
import Image from 'next/image';
import { WhatsappIcon } from '@/components/shared/CustomIcons';
