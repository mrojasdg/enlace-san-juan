        ...
        <div className="w-full h-full relative cursor-crosshair">
                        ...
                        >
                            <Popup>
                                <div className="p-2 max-w-[200px] flex flex-col gap-2">
                                    <h4 className="font-outfit font-black text-sm text-green-deeper mb-0 leading-tight">{biz.name}</h4>
                                    <p className="font-jakarta text-[11px] text-muted line-clamp-2 leading-relaxed mb-1">{biz.tagline}</p>
                                    <a
                                        href={`/${biz.slug}`}
            ...
            <div className="absolute bottom-6 right-6 z-[1000] bg-green-deeper text-white px-6 py-4 rounded-3xl shadow-2xl border border-white/10 hidden md:block">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h5 className="font-outfit font-black text-[11px] uppercase tracking-widest leading-none mb-1">Mapa de Negocios</h5>
                        <p className="text-[10px] text-white/40 leading-none">San Juan del Río, Qro.</p>
                    </div>
                </div>
            </div>
        </div>
