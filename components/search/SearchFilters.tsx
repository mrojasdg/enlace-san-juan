            ...
            <div className="space-y-12">
                ...
                <section>
                    ...
                    <div className="relative group">
                        <Search className="absolute left-0 top-1/2 -translate-y-1/2 text-muted group-focus-within:text-green transition-colors" size={18} />
                        <input
                            type="text"
                ...
                <section>
                    ...
                    <div className="space-y-4">
                        {features.map((feature) => (
                            <label key={feature} className="flex items-center gap-4 group cursor-pointer">
                ...
                <div className="pt-4 flex flex-col gap-6">
                    <Button
                        onClick={handleApply}
                        size="lg" className="w-full py-4 rounded-2xl shadow-xl font-black tracking-tight text-base"
                    >
                        Refinar búsqueda
                    </Button>
                    <button
